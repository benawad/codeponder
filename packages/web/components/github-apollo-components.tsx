...
export type GetViewerReposNode = {
  ...
  defaultBranchRef: Maybe<GetViewerReposDefaultBranchRef>;

  languages: Maybe<GetViewerReposLanguages>;
...
export type GetViewerReposLanguages = {
  ...
  edges: Maybe<GetViewerRepos_Edges[]>;
};
...
export type GetViewerReposRepositoryTopics = {
  ...
  edges: Maybe<GetViewerRepos__Edges[]>;
};

export type GetViewerRepos__Edges = {
  __typename?: "RepositoryTopicEdge";

  node: Maybe<GetViewerRepos__Node>;
};
